/**
 * @file models.ts
 * @description 이 파일은 애플리케이션에서 사용 가능한 LLM 모델 옵션 목록을 상수로 정의합니다.
 * UI의 모델 선택 드롭다운 메뉴 등에 사용될 수 있습니다.
 */

// UI에 표시될 모델 선택 옵션 배열입니다.
...
// "extended-thinking" 이나 "o" 접두사를 포함하지 않는 모델 옵션만 필터링한 배열입니다.
