/**
 * @file settings-page/github-manager.tsx
 * @description
 * GitHub App 통합을 관리하는 컴포넌트.
 * GitHub 인증, 설치, 저장소 목록 조회 등을 처리하며,
 * 다양한 상태(인증 필요, 로딩, 에러, 정상)에 따라 다른 UI를 표시합니다.
 */
...
/**
 * @component GitHubManager
 * @description
 * GitHub App 통합 관리 컴포넌트.
 * 인증, 설치, 조직/개인 계정 선택, 저장소 목록을 관리하고, 기기하게 다른 상태에 따라
 * 적절한 UI를 표시합니다.
 *
 * @features
 * - GitHub 인증 상태 확인
 ...
 * - 조직/개인 계정 전환
 * - 저장소 목록 조회 및 페이지네이션
 * - 저장소 상세 정보 표시 (Private/Public, 기본 브랜치)
 * - GitHub에서 설치 관리
 * - 로딩, 에러, 인증 필요 상태 별도 처리
 */
