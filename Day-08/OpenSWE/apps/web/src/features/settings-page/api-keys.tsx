/**
 * @file settings-page/api-keys.tsx
 * @description
 * API 키 관리 컴포넌트.
 * LLM 제공자(Anthropic, OpenAI, Google)의 API 키를 관리하고, 보안을 위한 표시/숨김 토글 기능을 제공합니다.
 */
...
/**
 * 특정 API 키 입력 필드에 자동 포커스를 설정할지 결정
 * @param apiKeyId - API 키 ID
 * @param hasValue - 값이 있는지 여부
 * @returns 자동 포커스 여부
 */
 ...
 * @description
 * API 키 관리 탭 컴포넌트.
 * LLM 제공자별 API 키를 입력, 수정, 삭제하고, 보안을 위한 표시/숨김 토글을 제공합니다.
 *
 * @features
 * - Anthropic, OpenAI, Google GenAI API 키 관리
 * - 키 표시/숨김 토글
 * - 키 삭제 기능
 * - 설정된 키 시각적 표시 (Configured 뱃지)
 * - Anthropic 키 자동 포커스 (기본 제공자)
 */
